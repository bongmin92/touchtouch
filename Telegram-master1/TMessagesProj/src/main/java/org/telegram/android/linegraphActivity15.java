...
public class linegraphActivity15 extends Activity {
    //public static int[] emojis = new int[15];
    public double[] values = new double[15];
    String[] horlabels = new String[15];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linegraphView15 graphView = new linegraphView15(this, values, "", horlabels, verlabels, linegraphView.BAR);
