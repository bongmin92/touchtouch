...
public class linegraphActivity extends Activity {
    //public static int[] emojis = new int[7];
    public double[] values = new double[7];
    String[] horlabels = new String[7];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linegraphView graphView = new linegraphView(this, values, "", horlabels, verlabels, linegraphView.BAR);
