            ...
            if (imageView == null) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        Log.i("messagecatch22",view.getTag().toString());
                        //UseCollector.dbemoji.addContact(new Contactemoji(view.getTag().toString(),System.currentTimeMillis() / 1000));
                        ChangeEmojiService.dbemoji.addContact(new Contactemoji(view.getTag().toString(),System.currentTimeMillis() / 1000));
