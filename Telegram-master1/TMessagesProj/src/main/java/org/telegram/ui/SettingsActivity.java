...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate{
    ...
    public boolean onFragmentCreate() {
        ...
        ChangeEmojiService.avatarUpdater.parentFragment = this;
        ChangeEmojiService.avatarUpdater.delegate = new AvatarUpdater.AvatarUpdaterDelegate() {
            
            @Override
            public void didUploadedPhoto(TLRPC.InputFile file, TLRPC.PhotoSize small, TLRPC.PhotoSize big) {
                Log.i("NEED", "이게있어야 avatar가 바뀌는가");
    ...
    public void onFragmentDestroy() {
        ...
        ChangeEmojiService.avatarUpdater.clear();
    }
            ...
            writeButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if (i == 0) {
                                ChangeEmojiService.avatarUpdater.openCamera();
                                //Bitmap bitmap = ImageLoader.loadBitmap("/storage/emulated/0/success2.png", null, 1280, 1280);
                                //avatarUpdater.processBitmap(bitmap);
                            } else if (i == 1) {
                                ChangeEmojiService.avatarUpdater.openGallery();
                            } else if (i == 2) {
    ...
    public void onActivityResultFragment(int requestCode, int resultCode, Intent data) {
        ChangeEmojiService.avatarUpdater.onActivityResult(requestCode, resultCode, data);
    }

    @Override
    public void saveSelfArgs(Bundle args) {
        if (ChangeEmojiService.avatarUpdater != null && ChangeEmojiService.avatarUpdater.currentPicturePath != null) {
            args.putString("path", ChangeEmojiService.avatarUpdater.currentPicturePath);
        }
    }

    @Override
    public void restoreSelfArgs(Bundle args) {
        if (ChangeEmojiService.avatarUpdater != null) {
            ChangeEmojiService.avatarUpdater.currentPicturePath = args.getString("path");
        }
    }
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == overscrollRow) {
                return 0;
            } if (i == settingsSectionRow || i == supportSectionRow || i == messagesSectionRow  || i == contactsSectionRow) {
                return 1;
